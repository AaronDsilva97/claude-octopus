...
export const SKILL_REGISTRY = [
    ...
    { name: "octopus-architecture", description: "System architecture and API design with multi-AI consensus — use for design reviews and new subsystems", type: "skill", file: "octopus-architecture/SKILL.md" },
    { name: "octopus-quick", description: "Quick execution for ad-hoc tasks without full workflow overhead — use for small, self-contained requests", type: "skill", file: "octopus-quick/SKILL.md" },
    ...
    { name: "skill-council", description: "Run a configurable multi-LLM council with personas, budget caps, synthesis, veto gates, and optional implementation handoff.", type: "skill", file: "skill-council/SKILL.md" },
    ...
    { name: "skill-staged-review", description: "Use when a PR or feature needs both specification and code-quality review", type: "skill", file: "skill-staged-review/SKILL.md" },
    ...
    { name: "skill-task-management", description: "Manage tasks with Claude Code native tools — use to track TODOs, delegate work, and monitor progress", type: "skill", file: "skill-task-management/SKILL.md" },
