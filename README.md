...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-9.60.1-blue" alt="Version 9.60.1">
...
> 🆕 **v9.60.1 — grep -c arithmetic fix across 18 sites, Bash 3.2 floor enforced, provider intelligence via registry.**
>
...
|---------|--------------|
| **v9.60.1** (new) | grep -c arithmetic fix across 18 sites, Bash 3.2 floor enforced, provider intelligence via registry. |
