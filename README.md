...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-9.61.4-blue" alt="Version 9.61.4">
...
> 🆕 **v9.61.4 — Fix grasp_define timeout budgets that killed the define phase mid-answer (#868).**
>
...
|---------|--------------|
| **v9.61.4** (new) | Fix grasp_define timeout budgets that killed the define phase mid-answer (#868). |
